...
class TrafficSignalGUI:
    ...
    def create_widgets(self):
        for idx, lane in enumerate(self.lanes):
            ...
            frame.grid(row=0, column=idx, padx=10, pady=10, sticky="nsew")  # Fill frame in the grid
...
def run_gui():
    ...
    root.geometry("1000x200")  # Set a suitable window size
    root.minsize(1000, 200)  # Set minimum size for the window
