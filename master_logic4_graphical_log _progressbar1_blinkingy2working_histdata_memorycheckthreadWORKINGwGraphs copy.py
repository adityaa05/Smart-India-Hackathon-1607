...
if __name__ == "__main__":
    ...
    root = tk.Tk()
    controller = TrafficSignalController(lanes, lambda lane, color, remaining=None: gui.update_signal(lane, color, remaining), lambda lane, remaining, allocated_time: gui.update_progress(lane, remaining, allocated_time))
